 ...
 * {@link PageContext#REQUEST_SCOPE PageContext.REQUEST_SCOPE}<br>
 * <code>session</code> will be transformed to
 * {@link PageContext#SESSION_SCOPE PageContext.SESSION_SCOPE}<br>
 * <code>application</code> will be transformed to
 * {@link PageContext#APPLICATION_SCOPE PageContext.APPLICATION_SCOPE}<br>
 *
